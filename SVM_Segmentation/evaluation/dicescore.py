...
if __name__ == '__main__':
    img1 = np.asarray(imread('../SVM_Segmentation/synthetic_cell_images/synthetic_masks/mask4.png'))
    img2 = np.asarray(imread('../SVM_Segmentation/synthetic_cell_images/synthetic_masks/mask5.png'))
